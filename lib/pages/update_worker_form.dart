        ...
        children: [
          ...
          Padding(
              ...
              child: Column(
                children: const [
                  SizedBox(height: 20),
                  CustomInput(textLabel: 'Nombre', icon: Icons.edit),
                  SizedBox(height: 20),
                  CustomInput(textLabel: 'Telefono', icon: Icons.edit),
                  SizedBox(height: 20),
                  CustomInput(textLabel: 'Email', icon: Icons.edit),
                  SizedBox(height: 20),
                  CustomInput(textLabel: 'Rut', icon: Icons.edit),
                  SizedBox(height: 20),
                  CustomInput(textLabel: 'Edad', icon: Icons.edit),
                  SizedBox(height: 40),
